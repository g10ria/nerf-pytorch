...
def train():
    ...
    if args.dataset_type == 'llff':
        ...
        images, poses, render_poses, hwf, i_split = load_blender_data(args.datadir, args.half_res, args.quarter_res, args.testskip)
    ...
    if args.render_only:
        ...
        with torch.no_grad():
            ...
            print('test poses shape', render_poses[0:1,:,:].shape)

            rgbs, _ = render_path(render_poses[0:1,:,:], hwf, K, args.chunk, render_kwargs_test, gt_imgs=images, savedir=testsavedir, render_factor=args.render_factor)
